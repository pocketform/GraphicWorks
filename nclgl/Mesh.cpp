...
Mesh * Mesh::GenerateTriangle()
{
	...
	m->vertices[1] = Vector3(0.25f, 0.0f, 0.0f);
	m->vertices[2] = Vector3(-0.25f, 0.0f, 0.0f);

	m->vertices[3] = Vector3(0.0f, 0.0f, 0.5f);
	m->vertices[4] = Vector3(0.25f, 0.0f, 0.0f);
	m->vertices[5] = Vector3(-0.25f, 0.0f, 0.0f);

	m->vertices[6] = Vector3(0.0f, 0.0f, 0.5f);
	m->vertices[7] = Vector3(0.25f, 0.0f, 0.0f);
	m->vertices[8] = Vector3(0.0f, 0.5f, 0.0f);
...
Mesh * Mesh::GenerateQuad()
{
	...
	m -> textureCoords = new Vector2[m -> numVertices];
	m -> colours       = new Vector4[m -> numVertices];
	m -> normals       = new Vector3[m -> numVertices];//new !
	m -> tangents      = new Vector3[m -> numVertices];//new !
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		m -> tangents[i] = Vector3(1.0f, 0.0f,  0.0f);// new !
	}
